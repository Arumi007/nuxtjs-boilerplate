<template>
  <div class="container">
    <h1 class="welcome-text">พระอาจารย์ทองปาน จารุวัณโณ</h1>
    <div class="empty-box">
      <img src="/pu_thongpan.jpg" class="image" />
      <h2 class="birth-title">ชาติกำเนิด</h2>
      <p class="birth-detail">
        พระอาจารย์ต้น จารุวัณโณ ภิกขุ เป็นพระภิกษุสงฆ์ที่ปฏิบัติตามพระธรรมวินัยอย่างเคร่งครัด
        ท่านเป็นที่รู้จักในด้านการปฏิบัติวิปัสสนากรรมฐาน และมีคำสอนที่เน้นการปฏิบัติเพื่อละวางกิเลสและความทุกข์
        ท่านเป็นเจ้าอาวาสวัดป่าภูตะคาม
        ท่านมีคำสอนที่เน้นการพิจารณาความเป็นจริงของชีวิต และการฝึกฝนจิตใจให้เข้มแข็ง เพื่อที่จะเผชิญกับความทุกข์ได้โดยไม่หวั่นไหว
      </p>
      <div class="dharma-list">
        <span class="dharma-title" @click="toggleList">1. ธรรมเทศนา พระอาจารย์ทองปาน จารุวัณโณ</span>
      ...
      <div class="dharma-list">
        <span class="dharma-title" @click="goToDrive('https://drive.google.com/drive/folders/1DsBYUfV4jicRQbgiuYRYhDBPJjI6_qyR?usp=drive_link')">ดาวน์โหลดรวมพระธรรมเทศนา </span>
      </div>
