<template>
  <div class="container">
    <h1 class="welcome-text">พระอาจารย์ อุทัย สิริธโร</h1>
    <div class="empty-box">
      <img src="/pu_uthai.jpg" class="image" />
      <h2 class="birth-title">ชาติกำเนิด</h2>
      <p class="birth-detail">
        หลวงปู่เจ้าคุณอุทัย สิริธโร เกิดเมื่อวันที่ 12 มีนาคม พ.ศ. 2479 
        ที่บ้านหนองบก ตำบลหนองหิน อำเภอยโสธร จังหวัดอุบลราชธานี (ปัจจุบันคือ จังหวัดยโสธร) มีพี่น้องรวมทั้งหมด 3 คน 
        โดยหลวงปู่เจ้าคุณอุทัย สิริธโรเป็นบุตรคนโตของครอบครัว
      </p>
      <div class="dharma-list">
        <span class="dharma-title" @click="toggleList">ธรรมเทศนา พระอาจารย์ อุทัย สิริธโร</span>
