<template>
  <div class="container">
    ...
    <div class="empty-box">
      ...
      <div class="dharma-list">
        <span class="dharma-title" @click="goToDrive('https://drive.google.com/drive/folders/19M4LgRLOK6iKLDMsAzyJxNIGb4qROOaq?usp=drive_link')">ดาวน์โหลดรวมพระธรรมเทศนา </span>
      </div>
